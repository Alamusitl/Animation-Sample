...
public class ProgressDownloadView extends View {
    ...
    public ProgressDownloadView(Context context, AttributeSet attrs) {
        ...
        mBubbleWidth = (int) (45 * density);
        mBubbleHeight = (int) (35 * density);
        ...
        mPaintBlack.setStrokeWidth(5 * density);
        ...
        mPaintWhite.setStrokeWidth(5 * density);
        ...
        mPaintText.setTextSize(12 * density);
    }
