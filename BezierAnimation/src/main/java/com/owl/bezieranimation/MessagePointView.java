package com.owl.bezieranimation;
...
public class MessagePointView extends FrameLayout {
    //触摸滑动容差
    ...
    public MessagePointView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MessagePointView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.mContext = context;
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MessagePointView);
        mMaxDragLen = a.getDimension(R.styleable.MessagePointView_av_maxDragLen, DensityUtils.dp2px(mContext, DEFAULT_MAX_DRAG_LENGTH));
        mDotRadius = a.getDimension(R.styleable.MessagePointView_av_dotRadius, DensityUtils.dp2px(mContext, DEFAULT_DOT_RADIUS));
        mDotColor = a.getColor(R.styleable.MessagePointView_av_dotColor, DEFAULT_DOT_COLOR);
        mDotTextColor = a.getColor(R.styleable.MessagePointView_av_dotTextColor, DEFAULT_DOT_TEXT_COLOR);
        mDotText = a.getString(R.styleable.MessagePointView_av_dotText);
        mDotTextSize = a.getDimension(R.styleable.MessagePointView_av_dotTextSize, DensityUtils.sp2px(mContext, DEFAULT_DOT_TEXT_SIZE));
        a.recycle();
    ...
    private void init() {
        ...
        mTextView.setLayoutParams(new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT, Gravity.CENTER));
